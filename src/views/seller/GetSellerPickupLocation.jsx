...
import { get_seller_pickuplocation } from "../../store/Reducers/OrderReducer";
                ...
                <tr key={i}>
                  ...
                  >
                    <div className="flex justify-start items-center gap-4">
                      <Link
                        to={`/seller/dashboard/edit-pickup-location/${d._id}`}
                      ...
                      <Link
                        ...
                        to={`/seller/dashboard/pickuplocation/pickuplocationDetail/${d._id}`}
                      >
                        <FaEye />
                      </Link>
                    </div>
