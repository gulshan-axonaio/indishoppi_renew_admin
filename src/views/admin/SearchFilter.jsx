...
import { admin_get_searchFilter } from "../../store/Reducers/OrderReducer";
...
const SearchFilter = () => {
  ...
  const { successMessage, errorMessage, searchFilter } = useSelector(
    (state) => state.order
  );
...
//   console.log("totalProductType", totalProductType);
  ...
  useEffect(() => {
    dispatch(
      ...
      admin_get_searchFilter({ parPage, page: currentPage, searchValue })
    );
    ...
    <div className="px-2 lg:px-7 pt-5 ">
      <div className="flex justify-between items-center pb-4">
        ...
        <Link
          ...
          to="/admin/dashboard/add-search-filter"
        >
          Add New
        </Link>
      </div>
                ...
                <tr key={i}>
                  ...
                  >
                    <div className="flex justify-start items-center gap-4">
                      <Link
                        to={`/admin/dashboard/edit-searach-filter/${d._id}`}
