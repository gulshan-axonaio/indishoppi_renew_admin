    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4  bg-[#283046] rounded-md">
        <div className="flex justify-between items-center p-4">
          <h2 className="text-3xl text-[#d0d2d6]">Order Details</h2>
          <select
        ...
        <div className="p-4">
          <div className="flex gap-2  flex-col text-lg text-[#d0d2d6]">
            <h2>#{order._id}</h2>
            ...
            <div className="w-[32%]">
              <div className="pr-3 text-[#d0d2d6] text-lg">
                ...
                <div className="mt-4 flex flex-col gap-8">
                  <div className="text-[#d0d2d6] my-5">
                    {order.products &&
                      order.products.map((p, i) => (
                        <div key={i} className="flex  gap-4 my-4 text-md">
                          <img
              ...
              <div className="pl-3">
                <div className="mt-4 flex flex-col">
                  {order?.suborder?.map((o, i) => (
                    <div key={i + 20} className="text-[#d0d2d6] my-6">
                      <div className="flex justify-start items-center gap-3">
                        <h2>Seller {i + 1} order : </h2>
                        <span>{o.delivery_status}</span>
                      </div>
                      {o.products?.map((p, i) => (
                        <div className="flex gap-3 text-md mt-2 my-4">
                          <img
                            className="w-[45px] h-[45px]"
                            src={p.images[0]}
                            alt=""
